...
import { TutorialNavigator, Tutorial, Breadcrumbs, TutorialStore, ArticleStore, loadSettingsAction, Constants } from '../../src/App';
...
app.getPlugin('ServiceProxyPlugin').registerService(Constants.ArticleServiceName, { loadArticle : service });
